...
import { CheckCircle, Clock, Edit2, Trash2, X } from "lucide-react";
    ...
    <div className="animate-in fade-in slide-in-from-bottom-2 space-y-8 duration-500">
      <div className="flex flex-col gap-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:flex-row md:items-center md:justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              variant={currentStatus === "SUBMITTED" ? "primary" : "ghost"}
              size="sm"
              className={
      ...
      <div className="overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-sm">
        <div className="flex items-center justify-between border-b border-slate-200 bg-slate-50 px-8 py-4">
          ...
          {isEditing && (
            <span className="flex animate-pulse items-center gap-1.5 text-xs font-bold text-blue-600">
